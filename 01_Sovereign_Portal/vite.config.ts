  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        '/cam-proxy/c120': { target: 'http://c120.taila01894.ts.net:8081', secure: false, changeOrigin: true, rewrite: (path) => path.replace(/^\/cam-proxy\/c120/, '') },
        ...
        '/ws-comet': {
          ...
          secure: false,
          changeOrigin: true,
          rewrite: (path) => path.replace(/^\/ws-comet/, ''),
        }
      }
    },
  };
