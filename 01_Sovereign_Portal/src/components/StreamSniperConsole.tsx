          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 sm:p-6">
              <div className="bg-[#111827] border border-[#ff0033]/30 rounded-xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden">
                  <div className="flex justify-between items-center p-4 border-b border-white/10 shrink-0 bg-black/50">
                      ...
                      <button onClick={() => setViewMediaFilename(null)} className="text-white/50 hover:text-white p-1 transition-colors">
                          <X className="w-6 h-6" />
                      </button>
                  </div>
                  <div className="w-full bg-black flex items-center justify-center relative flex-1 min-h-0">
                      <video 
                          ...
                          controls 
                          autoPlay 
                          className="w-full h-full object-contain outline-none max-h-[calc(90vh-4rem)]"
                      />
                  </div>
              </div>
          </div>
