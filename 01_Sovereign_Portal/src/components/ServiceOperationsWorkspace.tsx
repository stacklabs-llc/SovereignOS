...
/* ── Modern Professional Theme-Aware Tokens ── */
const VM = {
  bg:       "var(--color-bg, #09090b)",
  surface:  "var(--color-surface, #18181b)",
  card:     "var(--color-card, #27272a)",
  border:   "var(--color-border, #3f3f46)",
  orange:   "#f97316",
  emerald:  "var(--color-accent, #3b82f6)", // Dynamic accent color (e.g. Red for ESPN)
  blue:     "var(--color-accent, #3b82f6)",
  gold:     "#eab308",
