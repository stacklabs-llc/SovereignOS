...
const StartScreen: React.FC<StartScreenProps> = ({ onFileSelect, onStartFusion }) => {
    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        <h1 className="text-5xl font-extrabold tracking-tight text-gray-100 sm:text-6xl md:text-7xl">
          HoloDex <span className="text-blue-400">Imaging Interface</span>.
        </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                ...
                {onStartFusion && (
                    <button 
                        ...
                        className="relative inline-flex items-center justify-center px-10 py-5 text-xl font-bold text-white bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full cursor-pointer group hover:from-indigo-500 hover:to-purple-500 transition-all shadow-lg shadow-indigo-500/20 active:scale-95"
                    >
                        <MagicWandIcon className="w-6 h-6 mr-3 text-indigo-200" />
                        Image Fusion Workspace
                    </button>
                )}
            </div>
