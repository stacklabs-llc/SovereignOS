  ...
  useEffect(() => {
    ...
    ws.onmessage = async (event) => {
      try {
        ...
        if (msg.type === 'HOLOLINK_REQUEST' && msg.target === 'eileen_tv') {
        ...
        else if (msg.type === 'WEBRTC_ANSWER' && msg.target === 'eileen_tv') {
        ...
        else if (msg.type === 'WEBRTC_ICE_CANDIDATE' && msg.target === 'eileen_tv') {
          if (peerConnectionRef.current) {
