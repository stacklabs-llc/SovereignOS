...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/api/studio': 'http://127.0.0.1:8097',
      '/api/properties': 'http://127.0.0.1:8097',
      '/api/session': 'http://127.0.0.1:8000',
      ...
      '/api/persona_image': 'http://127.0.0.1:8090',
      '/api/chat/upload': 'http://127.0.0.1:8000',
      '/api/chat': 'http://127.0.0.1:8000',
      '/api/media/inject': 'http://127.0.0.1:8000',
      '/api/media': 'http://127.0.0.1:8090',
      '/api/system': 'http://127.0.0.1:8090',
      '/api/game-log': 'http://127.0.0.1:8000',
