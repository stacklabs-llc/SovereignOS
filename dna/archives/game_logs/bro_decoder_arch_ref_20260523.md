...
### 1. Cadence Mappings
* **`yapper`:** Rapid, conversational, pre-game ambient polling rate.
...
* `setup_all_rooms.py`: Deploys active game rows into `cmdb_ci_fanstack_room` and seeds starting persona configurations.
