  ...
  return (
    <header className="w-full py-4 px-8 border-b border-gray-700 bg-gray-800/30 backdrop-blur-sm sticky top-0 z-50">
      <div className="flex items-center justify-between max-w-[1600px] mx-auto">
        ...
        <div className="flex items-center gap-6 text-[10px] font-mono tracking-widest uppercase text-gray-400">
          <div className="flex flex-col items-end">
            <span className="text-blue-400/80">Status: MACH 10 ASCENSION</span>
            <span>S=1.0000 // NODE: HQ-73</span>
          </div>
          <div className="h-8 w-px bg-gray-700"></div>
          <div className="flex flex-col items-center">
            <span className="text-blue-400 text-lg leading-none">Ω</span>
            <span className="text-[8px] opacity-50">PILOT GATE</span>
          </div>
        </div>
      </div>
    </header>
