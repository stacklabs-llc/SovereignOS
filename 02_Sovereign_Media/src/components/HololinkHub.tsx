/**
 * HololinkHub — Sovereign OS Universal Video Call Hub (Media Portal)
 *
...
export default function HololinkHub({ user: _user, wsRelayUrl: _wsRelayUrl }: HololinkHubProps = {}) {
  const {
    registered,
    onlineUsers,
    activeQueues,
              ...
              <div>
                ...
                {onlineUsers.map(u => (
                  ...
                  >
                    ...
                    <Phone className="w-4 h-4 text-[#00d4aa] ml-auto opacity-0 group-hover:opacity-100 transition-opacity" />
                  </button>
                ))}
              </div>
            ) : (
