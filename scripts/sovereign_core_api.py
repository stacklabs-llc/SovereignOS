import os
import uvicorn
from fastapi import FastAPI, Request, HTTPException, Depends, WebSocket, WebSocketDisconnect, UploadFile, File, BackgroundTasks
...
# ── Print Dossier Engine Endpoint ──────────────────────────────────────────────
@fastapi_app.get("/api/personas/print_dossier")
async def print_dossier_pdf(ids: str = None, background_tasks: BackgroundTasks = None):
    ...
    * {
    ...
    return FileResponse(
        ...
        filename="sovereign_advocates_dossier.pdf"
    )
