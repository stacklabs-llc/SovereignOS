...
export default function GlobalSystemBar({
  ...
  return (
    <div style={containerStyle} className="pointer-events-auto">
      ...
      <div className="flex items-center gap-2 bg-[#0B0E14]/80 backdrop-blur-md border border-white/10 px-4 py-2 rounded-full shadow-lg">
        ...
        <span className="text-[10px] font-bold text-white/70 tracking-widest font-mono">
          {isDev ? 'DEV ENVIRONMENT' : 'PROD ENVIRONMENT'}
        </span>
      </div>
      ...
      <div className="pl-4 border-l border-white/20 ml-2 relative">
        ...
        {isAccountOpen && (
          <div className="absolute right-0 top-full mt-2 w-52 bg-[#0f172a] border border-white/10 rounded-xl shadow-2xl z-[1000] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
